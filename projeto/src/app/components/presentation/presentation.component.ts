...
export class PresentationComponent {
  ...
  <p>
    Tenho 4 anos de experiência em desenvolvimento web, atuando no setor público, sempre com o objetivo de entregar soluções funcionais, seguras e visualmente atrativas.
  </p>  
